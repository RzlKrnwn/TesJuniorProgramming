            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="p-5">
                        ...
                        <form class="user" method="POST" action="<?= base_url('home/tambah'); ?>">
                            <div class="form-group">
                                <p class="pl-3">ID Produk</p>
                                <input type="text" class="form-control form-control-user" id="id_produk" name="id_produk">
                            ...
                            <div class="grid">
                                ...
                                <div class="row">
                                    <div class="pl-4">
                                        <input type="radio" id="bisa dijual" name="status" value="bisa dijual">
                                        <label for="bisa dijual">Bisa Dijual</label>
                                    </div>
                                    <div class="pl-5">
                                        <input type="radio" id="tidak bisa dijual" name="status" value="tidak bisa dijual">
